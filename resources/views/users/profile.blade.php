  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ url('/user') }}" class="nav-link">Profile</a>
        </li>
    </ul>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal"  action="{{ route('user.change', auth()->user()->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="the-message"><strong>{{ $errors->first('password') }}</strong></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <span class="the-message"><strong>{{ $errors->first('password_confirmation') }}</strong></span>
                        </div>
                      </div>
