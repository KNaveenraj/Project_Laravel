    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ url('/admin/profile') }}" class="nav-link">Profile</a>
                </li>
            </ul>
                        ...
                        <div class="col-md-3">
                                ...
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid img-circle"
                                            src="/uploads/{{ auth()->user()->image }}" alt="User profile picture">
                                    </div>
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">
                                        M.Tech in Computer Science from VIT
                                    </p>
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="settings">
                                            <form class="form-horizontal"
                                                action="{{ route('admin.change', auth()->user()->id) }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <span
                                                            class="the-message"><strong>{{ $errors->first('email') }}</strong></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <span
                                                            class="the-message"><strong>{{ $errors->first('password') }}</strong></span>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="confirmation" class="col-sm-2 col-form-label">Confirm
                                                        Password</label>
                                                    <div class="col-sm-10">
                                                        ...
                                                        <span
                                                            class="the-message"><strong>{{ $errors->first('password_confirmation') }}</strong></span>
                                                    </div>
                                                </div>
