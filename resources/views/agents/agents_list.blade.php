        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/agent">Home</a></li>
              ...
              <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      <tr align=justify>
                          ...
                          <td align = center>
                            <a href = "{{route('agent.edit',$student->id)}}" class="btn btn-primary">Edit</a>
                            <a href = "{{route('agent.delete',$student->id)}}" class="btn btn-primary"  onclick="return confirm('{{ __('Are you sure you want to delete?') }}')">{{ __('Delete') }}</a>
                        </td>
                      </tr>
                      @endforeach
