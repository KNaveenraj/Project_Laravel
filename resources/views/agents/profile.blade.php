  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ url('/agent') }}" class="nav-link">Home</a>

        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ url('/agent/profile') }}" class="nav-link">Profile</a>
        </li>
    </ul>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal"  action="{{ route('agent.change', auth()->user()->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                    ...
                    @endif
                      ...
                      <div class="form-group row">
                        ...
                        <span class="invalid-feedback">
                            <strong>{{ $errors->first('password_confiramtion') }}</strong>
                        </span>
                    @endif
                      </div>
